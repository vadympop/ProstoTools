...
class Economy(commands.Cog, name="Economy"):
    ...
    @commands.command(
        description="**Купляет указанный товар**", usage="buy [Имя товара]"
    )
    @commands.cooldown(2, 10, commands.BucketType.member)
    async def buy(
    ...
    @commands.command(
        description="**Открывает указаный лут бокс**", usage="open [Лут бокс]"
    )
    @commands.cooldown(2, 10, commands.BucketType.member)
    ...
    @commands.command(
        description="**Незаконная добыча денег(Cooldown - 12 часов)**", usage="crime"
    )
    ...
    @commands.command(
        description="**Показывает ваш инвертарь**", usage="invertory", aliases=["inv"]
    )
    @commands.cooldown(2, 10, commands.BucketType.member)
