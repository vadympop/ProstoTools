...
class Moderate(commands.Cog, name="Moderate"):
	...
	@commands.command(
		aliases=["slowmode"],
		name="slow-mode",
		description="Ставит медленный режим указаному каналу(Если канал не указан медленный режим ставиться всем каналам, 0 - выключает медленный режим, длительность не указывать меньше нуля)",
